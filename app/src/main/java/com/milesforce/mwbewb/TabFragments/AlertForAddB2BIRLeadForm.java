...
import com.milesforce.mwbewb.Utils.CallStatues;
...
public class AlertForAddB2BIRLeadForm {
    ActionBar actionBar;
    Toolbar toolbar;
    ...
    public void addb2bIRLeadForm(final Context context, String accessToken, String callLogs) {
        ...
        lead_b2b_ir_mobile.setText(callLogs);
        lead_b2b_ir_mobile.setFocusable(false);
